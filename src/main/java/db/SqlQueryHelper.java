...
class SqlQueryHelper {
    ...
    * */
    ...
    final static String sqlInsertXMLObjects = String.format("INSERT INTO %s(%s, %s, %s) values(?, ?, ?)",
    ...
    final static String sqlInsertXMLObject = String.format("INSERT INTO %s(%s, %s, %s) values(?, ?, ?)",
    ...
    final static String sqlInsertXMLAttribute = String.format("INSERT INTO %s(%s, %s, %s, %s) values(?, ?, ?, ?)",
    ...
    final static String sqlInsertXMLData = String.format("INSERT INTO %s(%s, %s, %s) values(?, ?, ?)",
    ...
    final static String sqlInsertAllXMLObjects = String.format("INSERT INTO %s(%s, %s, %s) values",
            PropertiesManager.getSqlTableProperties().getProperty("XML_OBJECTS_TABLE_NAME"),
            PropertiesManager.getSqlTableProperties().getProperty("FOREIGN_KEY_MODEL_FILES"),
            PropertiesManager.getSqlTableProperties().getProperty("XML_OBJECTS_NAME"),
            PropertiesManager.getSqlTableProperties().getProperty("XML_OBJECTS_CLASS"));
    final static String sqlInsertAllXMLObject = String.format("INSERT INTO %s(%s, %s, %s) values",
            PropertiesManager.getSqlTableProperties().getProperty("XML_OBJECT_TABLE_NAME"),
            PropertiesManager.getSqlTableProperties().getProperty("FOREIGN_KEY_XML_OBJECTS"),
            PropertiesManager.getSqlTableProperties().getProperty("XML_OBJECT_NAME"),
            PropertiesManager.getSqlTableProperties().getProperty("XML_OBJECT_CLASS"));
    final static String sqlInsertAllXMLAttribute = String.format("INSERT INTO %s(%s, %s, %s, %s) values",
            PropertiesManager.getSqlTableProperties().getProperty("XML_ATTRIBUTE_TABLE_NAME"),
            PropertiesManager.getSqlTableProperties().getProperty("FOREIGN_KEY_XML_OBJECT"),
            PropertiesManager.getSqlTableProperties().getProperty("XML_ATTRIBUTE_NAME"),
            PropertiesManager.getSqlTableProperties().getProperty("XML_ATTRIBUTE_UNIT"),
            PropertiesManager.getSqlTableProperties().getProperty("XML_ATTRIBUTE_DATA_TYPE"));
    final static String sqlInsertAllXMLData = String.format("INSERT INTO %s(%s, %s, %s) values",
            PropertiesManager.getSqlTableProperties().getProperty("XML_DATA_TABLE_NAME"),
            PropertiesManager.getSqlTableProperties().getProperty("FOREIGN_KEY_XML_ATTRIBUTE"),
            PropertiesManager.getSqlTableProperties().getProperty("XML_DATA_COMPONENT_NAME"),
            PropertiesManager.getSqlTableProperties().getProperty("XML_DATA_VALUE"));
    ...
    final static String sqlInsertTxtEnergyBalance = String.format("INSERT INTO %s(%s, %s, %s, %s) values(?, ?, ?, ?)",
    ...
    final static String sqlInsertTxtMassBalance = String.format("INSERT INTO %s(%s, %s, %s, %s, %s, %s) values(?, ?, ?, ?, ?, ?)",
    ...
    final static String sqlInsertTxtComponents = String.format("INSERT INTO %s(%s, %s, %s, %s) values(?, ?, ?, ?)",
    ...
    final static String sqlInsertModel = String.format("INSERT INTO %s(%s, %s, %s, %s, %s, %s, %s, %s, %s) values(?, ?, ?, ?, ?, ?, CURRENT_DATE(), ?, ?)",
    ...
    final static String sqlLastInsertId = "SELECT last_insert_id()";
    final static String sqlLastIdFromTableName = "SELECT MAX(`id`) FROM %s";

    // Запросы выборки данных из XML файла
    final static String sqlSelectObjects = String.format("SELECT obj.%s, obj.%s, obj.id FROM %s obj INNER JOIN " +
            ...
            PropertiesManager.getSqlTableProperties().getProperty("MODEL_FILES_TABLE_NAME"),
            PropertiesManager.getSqlTableProperties().getProperty("FOREIGN_KEY_MODEL_FILES"));
    final static String sqlSelectObject = String.format("SELECT obj.%s, obj.%s, obj.id FROM %s as obj INNER JOIN " +
            ...
            PropertiesManager.getSqlTableProperties().getProperty("XML_OBJECTS_TABLE_NAME"),
            PropertiesManager.getSqlTableProperties().getProperty("FOREIGN_KEY_XML_OBJECTS"));
    final static String sqlSelectAttributes = String.format("SELECT attr.id, attr.%s, attr.%s, attr.%s " +
            ...
            PropertiesManager.getSqlTableProperties().getProperty("XML_OBJECT_TABLE_NAME"),
            PropertiesManager.getSqlTableProperties().getProperty("FOREIGN_KEY_XML_OBJECT"));
    final static String sqlSelectData = String.format("SELECT dat.id, dat.%s, dat.%s FROM %s dat INNER JOIN " +
    ...
    final static String sqlSelectComponent = String.format("SELECT comp.%s, comp.%s, comp.%s FROM %s comp INNER JOIN " +
            ...
            PropertiesManager.getSqlTableProperties().getProperty("MODEL_FILES_TABLE_NAME"),
            PropertiesManager.getSqlTableProperties().getProperty("FOREIGN_KEY_MODEL_FILES"));
    final static String sqlSelectEnergyBalance = String.format("SELECT energy.%s, energy.%s, energy.%s FROM %s energy INNER JOIN " +
            ...
            PropertiesManager.getSqlTableProperties().getProperty("MODEL_FILES_TABLE_NAME"),
            PropertiesManager.getSqlTableProperties().getProperty("FOREIGN_KEY_MODEL_FILES"));
    final static String sqlSelectMassBalance = String.format("SELECT mass.%s, mass.%s, mass.%s, mass.%s, mass.%s FROM %s mass INNER JOIN " +
    ...
    final static String sqlSelectModelsByParams = String.format("SELECT model.%s as main, model.%s as dxf, model.%s as name, model.%s as png, " +
            ...
            PropertiesManager.getSqlTableProperties().getProperty("TXT_MASS_BALANCE_INPUT_2"),
            PropertiesManager.getSqlTableProperties().getProperty("TXT_MASS_BALANCE_NAME"));
    final static String sqlSelectTypeModels = String.format("SELECT * FROM %s",
            PropertiesManager.getSqlTableProperties().getProperty("MODEL_TYPE_TABLE_NAME"));

    final static String sqlSelectUserData = String.format("SELECT user.%s as login, user.%s as password, user.id," +
